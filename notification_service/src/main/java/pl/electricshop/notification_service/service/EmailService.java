package pl.electricshop.notification_service.service;
...
public class EmailService {
    ...
    private Context createEmailContext(String link, LocalDateTime expiresAt, String email) {
        ...
        LocalDateTime requestedAt = expiresAt.plusMinutes(expiryMinutes);
        ctx.setVariable("requestedAt", requestedAt);
